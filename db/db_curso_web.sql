...
--
-- Host: 127.0.0.1
-- Tempo de geração: 02-Abr-2020 às 08:03
...
--
-- Estrutura da tabela `tb_alunos_cursos`
--
...
--
-- Extraindo dados da tabela `tb_alunos_cursos`
--

INSERT INTO `tb_alunos_cursos` (`id_aluno`, `id_curso`) VALUES
(8, 1);
...
(6, 'php_mysql.jpg', 'PHP e MySQL', 'Curso completo de PHP e MySQL', '0000-00-00 00:00:00', 1, 39.90, 10),
(7, NULL, 'Banco de Dados MySQL', 'Curso sobre banco de dados MySQL, entendendo tudo sobre um CRUD.', '2020-04-02 06:14:37', 1, 235.00, 10);
...
--
-- Índices para tabela `tb_alunos_cursos`
--
...
--
-- Limitadores para a tabela `tb_alunos_cursos`
--
ALTER TABLE `tb_alunos_cursos`
  ADD CONSTRAINT `tb_alunos_cursos_ibfk_1` FOREIGN KEY (`id_aluno`) REFERENCES `tb_alunos` (`id_aluno`),
  ADD CONSTRAINT `tb_alunos_cursos_ibfk_2` FOREIGN KEY (`id_curso`) REFERENCES `tb_cursos` (`id_curso`);
COMMIT;
